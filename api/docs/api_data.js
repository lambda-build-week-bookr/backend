define({ "api": [
    ...
    "permission": [
      {
        ...
        "description": "<p>Only users with the role admin can access this endpoint</p>"
      }
    ],
    "header": {
      "fields": {
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "NonUnique",
            "description": "<p>Unique constraint for this request was not met</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
  ...
  },
  {
    ...
    "name": "EditReview",
    "group": "Reviews",
    "description": "<p>NOTE: This request ID is the id of the review you want to edit.</p>",
    "header": {
      "fields": {
        "Header": [
          {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "reviews.rating",
            "description": "<p>Updated star rating (1-5) of the review.</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "review.content",
            "description": "<p>Updated body content of the review.</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "name": "UserReviews",
    "group": "Reviews",
    "description": "<p>NOTE: This request ID is the id of the user you want to retrieve reviews for.</p>",
    "header": {
      "fields": {
        "Header": [
          {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "reviews",
            "description": "<p>A list of the reviews for the requested user id.</p>"
          },
          {
            "group": "Success 200",
            "type": "integer",
